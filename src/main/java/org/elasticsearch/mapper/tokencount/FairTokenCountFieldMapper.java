...
public class FairTokenCountFieldMapper extends IntegerFieldMapper {
    public static final String CONTENT_TYPE = "fair_token_count";

    public static class Defaults extends IntegerFieldMapper.Defaults {

    }

    public static class Builder extends NumberFieldMapper.Builder<Builder, FairTokenCountFieldMapper> {
        ...
        @Override
        public FairTokenCountFieldMapper build(BuilderContext context) {
            setupFieldType(context);
            FairTokenCountFieldMapper fieldMapper = new FairTokenCountFieldMapper(name, fieldType, defaultFieldType,
                    ignoreMalformed(context), coerce(context), context.indexSettings(),
                    analyzer, multiFieldsBuilder.build(this, context), copyTo);
            return (FairTokenCountFieldMapper) fieldMapper.includeInAll(includeInAll);
        }
    ...
    public static class TypeParser implements Mapper.TypeParser {
        ...
        public Mapper.Builder parse(String name, Map<String, Object> node, ParserContext parserContext) throws MapperParsingException {
            Builder builder = new FairTokenCountFieldMapper.Builder(name);
    ...
    protected FairTokenCountFieldMapper(String simpleName, MappedFieldType fieldType, MappedFieldType defaultFieldType, Explicit<Boolean> ignoreMalformed,
    ...
    protected void parseCreateField(ParseContext context, List<Field> fields) throws IOException {
        ...
        if (fieldType().indexOptions() != NONE || fieldType().stored() || fieldType().hasDocValues()) {
            ...
            if (valueAndBoost.value() == null) {
                ...
                count = countTokens(analyzer, simpleName(), valueAndBoost.value());
            }
    ...
    protected void doMerge(Mapper mergeWith, boolean updateAllTypes) {
        ...
        this.analyzer = ((FairTokenCountFieldMapper) mergeWith).analyzer;
    }
